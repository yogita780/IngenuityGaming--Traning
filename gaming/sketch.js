...
var coinsImage,coinsGroup, coin_running ;
var coinsScore =0;
var coinSound;
var jumpSound;
var bgSound;
...
function preload() {
  ...
  jumpSound = loadSound("./sound/sounds_jump.mp3");
  bgSound = loadSound("./sound/mario-bg.mp3");
}
...
function setup() {
  ...
  // coin.addAnimation("running", coin_running);
...
function draw() {
  ...
  textSize(20);
  fill("brown");
  text("coin collected :" + coinsScore ,500,50 );
}
